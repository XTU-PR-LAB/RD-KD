...
MODEL_TYPE = {
    ...
    'ViT-Small': {
        ...
        'ckpt_file': "/home/aoao/n417/zhaoyajuan/monodepth2-master/metric3D_weights/metric_depth_vit_small_800k.pth",
    },
    'ViT-Large': {
...
if __name__ == '__main__':
    ...
    rgb_file = '/home/aoao/417/datasets/kitti_data/2011_09_26/2011_09_26_drive_0001_sync/image_03/data/0000000005.jpg'
    depth_file = '/home/aoao/417/datasets/kitti_data_depth/2011_09_26_drive_0001_sync/proj_depth/groundtruth/image_03/0000000005.png'
    ...
    model = torch.hub.load('/home/aoao/n417/zhaoyajuan/monodepth2-master/', 'metric3d_vit_small', pretrain=True,source='local')
    model.cuda().eval()
    with torch.no_grad():
